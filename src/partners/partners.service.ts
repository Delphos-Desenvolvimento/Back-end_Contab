  ...
  async update(id: number, updatePartnerDto: UpdatePartnerDto) {
    ...
    return this.prisma.partner.update({
      ...
      data: {
        ...
        ...(updatePartnerDto.logoBase64 !== undefined && {
          logoBase64: updatePartnerDto.logoBase64,
        }),
        ...(updatePartnerDto.displayOrder !== undefined && {
          displayOrder: updatePartnerDto.displayOrder,
        }),
        ...(updatePartnerDto.active !== undefined && {
          active: updatePartnerDto.active,
        }),
      },
      select: {
        id: true,
